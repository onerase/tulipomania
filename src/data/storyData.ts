...
export const storyData: Record<string, StoryNode> = {
  ...
  A1a: {
    ...
    level: 4,
    title: 'The Mania',
    text: 'You secure the coveted bloom, but the price is staggering, a sum that would purchase a fine house on the canal. Even amid the general frenzy, there are murmurs that you\'ve overextended yourself. The tulip sits in your vault like a ticking bomb, its value tied to the caprice of the crowd.',
    choices: [
